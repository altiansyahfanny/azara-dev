            ...
            <div className="w-full">
                <div>
                    <MeetingItem
                        ...
                        value={meeting.data.meetingNumber.toString()}
                    />
                    <MeetingItem
                    ...
                    <MeetingItem
                        label="Jam Selesai"
                        value={format(
                            parse(meeting.data.endTime, "HH:mm:ss", new Date()),
                            "HH:mm"
                        )}
                    />
                    <MeetingItem
                        ...
                        value={
                            teacherAttendanceMapper[
                                meeting.data.teacherAttendance
                            ]
                        }
                    />
                    <MeetingItem
                        label="Perwakilan Guru"
                        value={meeting.data.representedBy}
                    />
                    <MeetingItem
                        label="Verifikasi"
                        value={meeting.data.isVerified ? "Sudah" : "Belum"}
                    />
                ...
                <div className="mt-4">
                    ...
                    <div className="mt-2">
                        <MeetingItem
                            label="Nama Depan"
                            value={meeting.data.teacher.firstName}
                        />
                        <MeetingItem
                            label="Nama Belakang"
                            value={meeting.data.teacher.lastName}
                        />
                    </div>
                </div>
                ...
                <div className="mt-4">
                    ...
                    <div className="mt-2">
                        <MeetingItem
                            ...
                            value={meeting.data.course.courseName}
                        />
                        <MeetingItem
                            label="Keterangan"
                            value={meeting.data.course.description}
                        />
                    </div>
                </div>
                ...
                <div className="mt-4">
                    ...
                    <div className="mt-2">
                        <MeetingItem
                            label="Nama Kelas"
                            value={meeting.data.classroom.classroomName}
                        />
                        <MeetingItem
                            label="Harga"
                            value={formatNumber(meeting.data.classroom.price)}
                        />
                    </div>
                </div>
                ...
                <div className="mt-4">
                    ...
                    <div className="mt-2">
                        <MeetingItem
                            label="Tanggal Mulai"
                            value={meeting.data.cycle.startDate}
                        />
                        <MeetingItem
                            label="Tanggal Selesai"
                            value={meeting.data.cycle.endDate}
                        />
                    </div>
                </div>
            </div>
