			...
			<div className="relative md:flex">
				<div className="md:flex-1 lg:w-5/12 md:p-16 p-4 bg-green-200x">
					...
					<div className="text-white mt-8">
						<h2 className="text-lg font-bold 3xl:text-2xl">Jangan Lupa Kunjungi Kami</h2>
						<a
						...
						>
							...
							<p className="3xl:text-lg">
								Jl. Sagu No. 45, RT 007/ RW 005 Jagakarsa, Jakarta Selatan 12620
							</p>
						</a>
					</div>
				</div>
				<div className="md:flex-1 lg:w-3/12 p-4 md:p-16 text-white bg-red-200x">
					<div>
						<h2 className="text-lg font-bold 3xl:text-2xl">Tautan</h2>
						{NAVLINK.map((link) => (
							<a
								key={link.id}
								href={`#${link.id}`}
								className="text-gray-300 text-sm 3xl:text-xl hover:text-custom-green"
							>
								<h3>{link.name}</h3>
							</a>
						))}
					...
					<div className="mt-8">
						<h2 className="text-lg font-bold 3xl:text-2xl">Follow Kami</h2>
						<div className="flex-1 flex space-x-4 mt-2">
							...
							>
								<FaInstagram className="text-2xl 3xl:text-3xl" />
								<p className="3xl:text-xl">@azaracourse</p>
							</a>
						</div>
					</div>
				</div>
