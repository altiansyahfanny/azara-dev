...
const ServiceCard = ({
	...
	return (
		<>
			<div className="bg-custom-gray border border-gray-600 border-dashed text-white w-[250px] pb-4 px-6 pt-10 rounded-xl relative h-full hover:bg-[#47494d] hover:border-gray-200 hover:scale-105 transition-all">
				...
				<h1 className="text-2xl tracking-wide">{text}</h1>
				...
				<div className="flex items-center justify-center">
					<button
						...
						} hover:bg-custom-gray transition-all uppercase tracking-wide font-medium`}
