...
const Navbar = ({ hideMenu }: { hideMenu?: boolean }) => {
        ...
        const handleScroll = () => {
            ...
            NAVLINK.forEach((link) => {
                ...
                if (element) {
                    ...
                    const elementBottom =
                        elementTop + element.offsetHeight - NAV_HEIGHT;
            ...
            if (serviceElement) {
                const targetPosition =
                    serviceElement.getBoundingClientRect().top + window.scrollY;
                if (
                    scrollTop > targetPosition - NAV_HEIGHT &&
                    scrollTop <
                        targetPosition +
                            serviceElement.offsetHeight -
                            NAV_HEIGHT
                ) {
    ...
    return (
        ...
        >
            {/* LOGO */}
            <img
                src={cssOnScrollService ? LogoWhite : Logo}
                alt="logo"
