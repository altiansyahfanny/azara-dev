...
const TableBrowse: React.FC<TableBrowseProps> = ({ isBrowse = true }) => {
    ...
    const onAssign = (course: Course) => {
        ...
        dispatch(
            setModalStateTeacherSlice({ value: { modalAssignTeacher: true } })
        );
        dispatch(
            setModalStateTeacherSlice({ value: { modalAssignCourse: false } })
        );
    };
            ...
            render: (course: Course) => {
                return (
                    <div className="flex gap-x-2">
                        ...
                        {isBrowse && (
                            <Table.ButtonAction
                                onClick={() => onClickButtonUpdate(course)}
                                Icon={FilePenLine}
                            />
                        )}
                    </div>
