...
export default function CreateAttendance() {
	...
	const onSubmit = async () => {
		...
		try {
			...
			console.log('CreateAttebdance -> onFinish -> success : ', result.message);
	...
	return (
		<>
			<Table className="overflow-x-scroll border">
				<TableHeader>
					<TableRow>
						<TableHead className="whitespace-nowrap border">Nama Depan Siswa</TableHead>
						<TableHead className="whitespace-nowrap border">Nama Belakang Siswa</TableHead>
						<TableHead className="w-[100px] text-center border">Status</TableHead>
					</TableRow>
				</TableHeader>
				<TableBody>
