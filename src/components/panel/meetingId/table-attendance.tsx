...
const TableAttendance = () => {
    ...
    const [idAttendanceToDelete, setIdAttendanceToDelete] = useState<
        number | null
    >();
            ...
            render: (meetingAttendance: MeetingAttendance) => {
                return (
                    <div className="flex items-center gap-x-2">
                        <Table.ButtonAction
                            onClick={() =>
                                onClickButtonDelete(meetingAttendance.id)
                            }
                            Icon={Trash}
                        />
                    </div>
    ...
    const onSubmittedDelete = async () => {
        ...
        try {
            console.log(
                "onSubmittedDelete -> idAttendanceToDelete : ",
                idAttendanceToDelete
            );
