...
import { setPaginationState } from '@/store/features/paymentListSlice';
...
export const paymentApiSlice = apiSlice.injectEndpoints({
	endpoints: (builder) => ({
		getPayments: builder.query<ApiResponse<PaymentsResponse>, QueryParam<PaymentHistoryFilter>>({
		...
		addPayment: builder.mutation<ApiResponse, z.infer<typeof createPaymentSchema>>({
			query: (payload) => ({
